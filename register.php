...
$username_err = $password_err = $photo_err = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!empty($_FILES["file"]["name"])) {
    ...
    $photo_err = "Please upload a profile photo!";
  }

  // Check input errors before inserting in database
  if (empty($username_err) && empty($password_err) && empty($photo_err)) {
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)) {
      // Prepare an insert statement
      $sql = "INSERT INTO Users (username, password, email, bio, country, city, usr_photo_link) VALUES (?, ?, ?, ?, ?, ?, ?)";

      if ($stmt = mysqli_prepare($link, $sql)) {
        // Bind variables to the prepared statement as parameters
        mysqli_stmt_bind_param($stmt, "sssssss", $param_username, $param_password, $param_email, $param_bio, $param_country, $param_city, $param_photo_link);
            ...
            <div class="card-body">
              ...
              <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="group">Upload a nice profile photo!</label>
                  <label class="btn btn-primary fileupload ml-3">
                ...
                <img class="img-fluid rounded-top mb-3" id="output" />
                <script>
                ...
                <div class="form-group mb-4">
                  ...
                  <input type="text" name="username" id="username" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>" placeholder="Choose an Username">
                  <span class="invalid-feedback"><?php echo $username_err; ?></span>
                </div>
                <div class="form-group mb-4">
                  <label for="password" class="sr-only">Password</label>
                  <input type="password" name="password" id="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" placeholder="***********" value="<?php echo $password; ?>">
                  <span class="invalid-feedback"><?php echo $password_err; ?></span>
                </div>
                <div class="form-group mb-4">
                  <label for="bio" class="sr-only">Bio</label>
                  <input type="text" name="bio" id="bio" class="form-control" placeholder="Enter a one-liner about yourself!" value="<?php echo $bio; ?>">
                </div>
                <div class="form-group mb-4">
