...
$creatorquery = "SELECT Groups.group_id, Groups.groupname, Groups.creator_id, Groups.country, 
    Groups.city, Groups.max_cap, Groups.signed_up_users, Groups.description, Groups.photo_link, Users.username, Users.usr_photo_link
...
$joinedgroupsquery = "SELECT Groups.group_id, Groups.groupname, Groups.creator_id, Groups.country, 
    Groups.city, Groups.max_cap, Groups.signed_up_users, Groups.description, Groups.photo_link, Users.username, Users.usr_photo_link
    FROM Groups INNER JOIN Users ON Groups.creator_id=Users.id INNER JOIN GroupMembership ON Groups.group_id=GroupMembership.group_id WHERE GroupMembership.user_id = " . $_SESSION['id'] . " ORDER by group_id";
    ...
    <div class="main-wrapper">
        ...
        <div class="bg-img-hero" style="background: url(assets/images/hero-slide-img-1.jpg) no-repeat;">
            ...
            while ($row = $resultcreator->fetch_object()) {
                ...
                echo
                '<div class="pt-lg-8 pb-lg-8 pt-7 pb-7 bg-primary border-bottom">
                    <div class="container">
                        <div class="row d-flex justify-content-between">
                            <div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12">
                                <div class="mb-2">
                                    <h2 class="text-white">' . $row->groupname . '</h2>
                                    <p class="text-white mb-3 mt-2">' . $row->description . '</p>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 d-flex align-items-center">
                                <div class="">
                                    ...
                                    <input type="hidden" id="usrphoto" name="usrphoto" value=' . $row->usr_photo_link . '>
